...
```powershell
powershell.exe -noprofile -executionpolicy unrestricted { . { iwr -UseBasicParsing https://raw.githubusercontent.com/mrwizard82d1/winbox/0.1.79/files/default/install.ps1 } | iex;install-workstation }
```
